...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cities=arrayOf("Taipei","New Taipei City","Taoyuan City","Hsinchu City","Miaoli County","Taichung City","Changhua County","Nantou County","Yunlin County","Chiayi City","Tainan City","Kaohsiung City","Pingtung County","Yilan County","Hualien County","Taitung County","Keelung City","Penghu County","Jingmen County","Lianjiang County")
    ...
    private fun fetchWeather(cityName: String) {
        ...
        val apiKey = "419784b76be705c632b4d0d63ff61b6d"
